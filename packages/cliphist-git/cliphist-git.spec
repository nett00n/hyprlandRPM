...
Summary:        Wayland clipboard manager with support for multimedia [Built from latest commit, unstable]
...
%package devel
Summary:        Development files for Wayland clipboard manager with support for multimedia [Built from latest commit, unstable]
Requires:       %{name} = %{version}-%{release}

%description devel
Development files for cliphist-git.
